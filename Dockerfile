...
# Start the app
CMD [ "streamlit", "run" , "Home.py", "--server.port=8501", "--server.address=localhost", "--server.enableCORS=false", "--server.enableWebsocketCompression=true", "--logger.level=info", "--server.enableXsrfProtection=false"]
